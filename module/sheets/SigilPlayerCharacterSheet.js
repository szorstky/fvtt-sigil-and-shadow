export default class SigilPlayerCharacterSheet extends ActorSheet {
    ...
    getData(options) {
        ...
        data.items = actorData.items.filter(function(item){ return item.type == "equipment"});
    ...
    activateListeners(html) {
        ...
        new ContextMenu(html, ".armour-item", this.itemContextMenu);
        new ContextMenu(html, ".vehicle-item", this.itemContextMenu);
        new ContextMenu(html, ".equipment-item", this.itemContextMenu);
